...
const Order = () => {
  ...
  useEffect(() => {
    fetch(`https://peaceful-anchorage-11931.herokuapp.com/Garis/${vehicleId}`)
      .then((res) => res.json())
      .then((data) => setVehicle(data));
  }, []);
  const onSubmit = (data) => {
    axios
      .post("https://peaceful-anchorage-11931.herokuapp.com/order", data)
      .then((res) => {
        ...
        <div className="order-form container">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="default-data">
              <input {...register("vehicleImg")} type="url" value={img} />{" "}
              <br />
              <input
